...
const ClaimServices = {
  ...
  index(data) {
    ...
    return Vue.axios.get('/api/claim', {
      params: clonedata
    })
  },
  ...
  filter(data) {
    ...
    return Vue.axios.get('/api/filter/claim', {
      params: clonedata
    })
  },
  ...
  show(data) {
    PassportServices.AuthenticationServices.setHeader();
    return Vue.axios.get('/api/claim/' + data.uid);
  },
  ...
  create(data) {
    ...
    return Vue.axios.post('/api/claim', clonedata)
  },
  ...
  update(data) {
    ...
    return Vue.axios.put('/api/claim/' + clonedata.uid, clonedata);
  },
  ...
  delete(data) {
    ...
    return Vue.axios.delete('/api/claim/' + data.uid);
  },
