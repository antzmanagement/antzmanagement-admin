...
export default {
  ...
  methods: {
    ...
    print() {
      ...
      setTimeout(() => {
        print({
          printable: `printCleaning${this.uid}`,
          type: "html",
          style: styles,
          scanStyles: false,
          font_size: "7pt",
          documentTitle: `Cleaning Invoice ${this.data.receiptno}`,
          onPrintDialogClose: () => console.log("The print dialog was closed"),
          onError: (e) => console.log(e),
        });
        this.endLoadingAction();
        // console.log(`printCleaning${this.uid}`);
        // this.$htmlToPaper(`printCleaning${this.uid}`);
      }, 2000);
    },
  },
};
...
<template>
  <span>
    ...
    <div class="invoice-box d-none" :id="`printCleaning${uid}`">
      <table cellpadding="0" cellspacing="0">
            ...
            <table>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <div class="small-text">
                    Room Unit No #:
                    {{ _.get(data, ["room", "unit"]) ||  _.get(data, ["room", "name"]) || "N/A" }}
                  </div>
                </td>
              </tr>
            </table>
        ...
        <tr class="item subtitle">
          <td class="text-truncate">
            {{ _.get(data, ["cleaning_type"]) ? `${_.capitalize(_.get(data, ["cleaning_type"]))} Cleaning` : "N/A" }}
          </td>
          <td class="text-truncate">
