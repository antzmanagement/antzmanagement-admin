<template>
  <v-app>
    ...
    <v-content :class="helpers.managementStyles().backgroundClass">
              ...
              >
                <template v-slot:top>
                  <v-toolbar flat class="mb-5">
                    <v-btn color="primary" block class="ma-2" :disabled="isLoading" @click="serviceFilterDialog = true">
      ...
      <v-dialog v-model="serviceFilterDialog" persistent maxWidth="1200px" hideOverlay>
        <service-filter-form
...
export default {
  ...
  methods: {
    ...
    initServiceFilter(filterGroup) {
      ...
      if (filterGroup) {
        this.serviceFilterGroup.selectedRooms = filterGroup.rooms;
        this.serviceFilterGroup.rooms = filterGroup.rooms.map(function(
          serviceType
        ) {
