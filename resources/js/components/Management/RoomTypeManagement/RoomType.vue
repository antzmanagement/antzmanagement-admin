...
export default {
  ...
  methods: {
    ...
    deleteRoomType($isConfirmed, $uid) {
      if ($isConfirmed) {
        this.$Progress.start();
        this.showLoadingAction();
    ...
    print(data) {
      ...
      this.selectedRental.roomtype = this.data;
      this.selectedRental.roomtype.tenant = this.data.tenant;
      this.selectedRental.roomtype.room = this.data.room;
            ...
            <v-row class="pa-2" justify="end" align="center">
              ...
              <v-col cols="auto">
                <confirm-dialog
                  ...
                  @confirmed="deleteRoomType($event, data.uid)"
                ></confirm-dialog>
              </v-col>
            </v-row>
          </v-container>
        ...
        <div class="d-none" id="printMe">
          <v-container>
            ...
            <v-row>
              ...
              <v-col cols="8">
                <div :class="helpers.managementStyles().lightSubtitleClass">
                  {{ selectedRental.roomtype.tenant.name }}
                </div>
              </v-col>
            </v-row>
            <v-row>
              ...
              <v-col cols="8">
                <div :class="helpers.managementStyles().lightSubtitleClass">
                  {{ selectedRental.roomtype.room.name }}
                </div>
              </v-col>
            </v-row>
            <v-row>
            ...
            <v-row>
              ...
              <v-col cols="8">
                <div :class="helpers.managementStyles().lightSubtitleClass">
                  {{ selectedRental.roomtype.startdate | formatDate }}
                </div>
              </v-col>
            </v-row>
            <v-row>
