...
export default {
  ...
  methods: {
    ...
    print() {
      ...
      setTimeout(() => {
        print({
          printable: `printMaintenance${this.uid}`,
          type: "html",
          style: styles,
          scanStyles: false,
          font_size: "7pt",
          documentTitle: `Maintenance Invoice ${this.data.receiptno}`,
          onPrintDialogClose: () => console.log("The print dialog was closed"),
          onError: (e) => console.log(e),
        });
        this.endLoadingAction();
        // console.log(`printMaintenance${this.uid}`);
        // this.$htmlToPaper(`printMaintenance${this.uid}`);
      }, 2000);
    },
  },
};
...
<template>
  <span>
    ...
    <div class="invoice-box d-none" :id="`printMaintenance${uid}`">
